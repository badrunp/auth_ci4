                ...
                <div class="col">
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix pb-4">
                            <div class="pull-left">
                                <h4 class="text-blue h4">Edit form role</h4>
                            </div>
                        ...
                        <form action="<?= base_url("/role/update") . '/' . $role['id']; ?>" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input class="form-control <?= $validate->getError('name') ? 'is-invalid' : ''; ?>" type="text" name="name" placeholder="Name" value="<?= old('name', $role['name']); ?>">
